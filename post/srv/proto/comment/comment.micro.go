...
type CommentService interface {
	GetComments(ctx context.Context, in *post.Req, opts ...client.CallOption) (*Rsp, error)
}
...
func (c *commentService) GetComments(ctx context.Context, in *post.Req, opts ...client.CallOption) (*Rsp, error) {
...
type CommentHandler interface {
	GetComments(context.Context, *post.Req, *Rsp) error
}

func RegisterCommentHandler(s server.Server, hdlr CommentHandler, opts ...server.HandlerOption) error {
	type comment interface {
		GetComments(ctx context.Context, in *post.Req, out *Rsp) error
	}
	type Comment struct {
		comment
	}
...
func (h *commentHandler) GetComments(ctx context.Context, in *post.Req, out *Rsp) error {
