...
func (*BenchmarkMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_9ec8442d33902ef2, []int{0}
}
...
func init() {
	proto.RegisterType((*BenchmarkMessage)(nil), "proto.BenchmarkMessage")
}

func init() {
	proto.RegisterFile("benchmark/proto/micro_benchmark.proto", fileDescriptor_9ec8442d33902ef2)
}

var fileDescriptor_9ec8442d33902ef2 = []byte{
