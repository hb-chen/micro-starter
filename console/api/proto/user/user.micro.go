...
func (c *userService) Login(ctx context.Context, in *proto1.Request, opts ...client.CallOption) (*proto1.Response, error) {
...
func (c *userService) Logout(ctx context.Context, in *proto1.Request, opts ...client.CallOption) (*proto1.Response, error) {
...
func (h *userHandler) Login(ctx context.Context, in *proto1.Request, out *proto1.Response) error {
	return h.UserHandler.Login(ctx, in, out)
}

func (h *userHandler) Logout(ctx context.Context, in *proto1.Request, out *proto1.Response) error {
